...
export const module9Quiz: QuizLesson = {
  id: 9,
  ...
  content: {
    questions: [
      ...
      {
        question: 'What is the primary purpose of workflow automation in podcasting?',
        options: [
          'To increase production costs',
          'To minimize manual input for repetitive tasks',
          'To replace human creativity',
          'To reduce episode quality'
        ],
        correct: 1,
        explanation: 'Workflow automation minimizes manual input for repetitive tasks, ensuring consistent, accessible episode releases.'
      }
    ]
  }
};
