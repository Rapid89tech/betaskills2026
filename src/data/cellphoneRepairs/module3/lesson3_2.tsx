export const lesson3_2 = {
  ...
  type: 'video' as const,
  content: {
    videoUrl: 'https://youtu.be/GDYrCD5KlDg?si=4Hx1BRA3fLjs0ePP',
    textContent: `
