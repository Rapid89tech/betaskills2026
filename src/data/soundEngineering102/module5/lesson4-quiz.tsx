...
export const lesson4Quiz: Lesson = {
  ...
  content: {
    videoUrl: '',
    videoUrl2: '',
    textContent: `# 🎚️ Gain Staging Quiz
...
<div style="background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);color:white;padding:2rem;border-radius:16px;margin-bottom:2rem;text-align:center;">
  ...
  <p style="margin:0.5rem 0 0 0;font-size:1.1rem;opacity:0.9;">Complete this quiz to assess your understanding of mixing principles</p>
</div>
...
<div style="background:white;border:2px solid #e2e8f0;border-radius:12px;padding:2rem;margin-bottom:2rem;box-shadow:0 4px 6px rgba(0,0,0,0.05);">
  ...
  <div style="display:grid;gap:0.8rem;">
    <div style="padding:1rem;border:2px solid #e2e8f0;border-radius:8px;cursor:pointer;transition:all 0.2s;background:#f7fafc;">
      <span style="font-weight:600;color:#4a5568;">A.</span> To make everything as loud as possible
    </div>
    <div style="padding:1rem;border:2px solid #e2e8f0;border-radius:8px;cursor:pointer;transition:all 0.2s;background:#f7fafc;">
      <span style="font-weight:600;color:#4a5568;">B.</span> To create automatic volume fades
    </div>
    <div style="padding:1rem;border:2px solid #e2e8f0;border-radius:8px;cursor:pointer;transition:all 0.2s;background:#f7fafc;">
      <span style="font-weight:600;color:#4a5568;">C.</span> To manage signal levels to avoid distortion and noise
    </div>
    <div style="padding:1rem;border:2px solid #e2e8f0;border-radius:8px;cursor:pointer;transition:all 0.2s;background:#f7fafc;">
      <span style="font-weight:600;color:#4a5568;">D.</span> To automate EQ changes
    </div>
  </div>
  ...
  <div style="margin-top:1.5rem;padding:1rem;background:#f0fff4;border-left:4px solid #48bb78;border-radius:8px;">
    ...
    <p style="margin:0.5rem 0 0 0;color:#2f855a;">Gain staging manages signal levels throughout the signal chain to avoid distortion and noise.</p>
  </div>
</div>
...
<div style="background:linear-gradient(135deg,#f093fb 0%,#f5576c 100%);color:white;padding:2rem;border-radius:16px;text-align:center;margin-top:3rem;">
  ...
  <p style="margin:0;font-size:1.1rem;opacity:0.9;">You've completed Module 5! You now understand mixing principles and gain staging.</p>
</div>
`
  }
}; 
