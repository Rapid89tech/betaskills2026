...
import CourseAvailabilityBadge from './courses/CourseAvailabilityBadge';
...
const HomeCourseCard = ({ course }: HomeCourseCardProps) => {
    ...
    <Card className="group h-full overflow-hidden transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl bg-white dark:bg-gray-800 border-0 shadow-lg">
      <div className="relative overflow-hidden">
        <div className="aspect-[4/3] relative">
          ...
          {/* Availability Badge - moved to bottom right */}
          <div className={`absolute bottom-3 right-3 px-2 py-1 rounded-full text-xs font-semibold shadow-lg ${
