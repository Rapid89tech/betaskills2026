...
export const lesson4Quiz: Lesson = {
  id: 4,
  title: 'Quiz: Types of Microphones',
  duration: '25 minutes',
  type: 'interactive',
  content: {
    videoUrl: '',
    videoUrl2: '',
    textContent: `# 🎧 Quiz: Types of Microphones
...
<div style="background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);color:white;padding:2rem;border-radius:16px;margin-bottom:2rem;text-align:center;">
  ...
  <p style="margin:0.5rem 0 0 0;font-size:1.1rem;opacity:0.9;">Complete this quiz to assess your understanding of microphone types and applications</p>
</div>
...
<div style="background:white;border:2px solid #e2e8f0;border-radius:12px;padding:2rem;margin-bottom:2rem;box-shadow:0 4px 6px rgba(0,0,0,0.05);">
  ...
  <div style="display:grid;gap:0.8rem;">
    <div style="padding:1rem;border:2px solid #e2e8f0;border-radius:8px;cursor:pointer;transition:all 0.2s;background:#f7fafc;">
      <span style="font-weight:600;color:#4a5568;">A.</span> To amplify sound directly
    </div>
    <div style="padding:1rem;border:2px solid #e2e8f0;border-radius:8px;cursor:pointer;transition:all 0.2s;background:#f7fafc;">
      <span style="font-weight:600;color:#4a5568;">B.</span> To convert sound into light
    </div>
    <div style="padding:1rem;border:2px solid #e2e8f0;border-radius:8px;cursor:pointer;transition:all 0.2s;background:#f7fafc;">
      <span style="font-weight:600;color:#4a5568;">C.</span> To convert sound into electrical signals
    </div>
    <div style="padding:1rem;border:2px solid #e2e8f0;border-radius:8px;cursor:pointer;transition:all 0.2s;background:#f7fafc;">
      <span style="font-weight:600;color:#4a5568;">D.</span> To store sound digitally
    </div>
  </div>
  ...
  <div style="margin-top:1.5rem;padding:1rem;background:#f0fff4;border-left:4px solid #48bb78;border-radius:8px;">
    ...
    <p style="margin:0.5rem 0 0 0;color:#2f855a;">A microphone is a transducer that converts sound (acoustic energy) into electrical signals.</p>
  </div>
</div>
...
<div style="background:white;border:2px solid #e2e8f0;border-radius:12px;padding:2rem;margin-bottom:2rem;box-shadow:0 4px 6px rgba(0,0,0,0.05);">
  ...
  <div style="display:grid;gap:0.8rem;">
    <div style="padding:1rem;border:2px solid #e2e8f0;border-radius:8px;cursor:pointer;transition:all 0.2s;background:#f7fafc;">
      <span style="font-weight:600;color:#4a5568;">A.</span> They require phantom power to operate
    </div>
    <div style="padding:1rem;border:2px solid #e2e8f0;border-radius:8px;cursor:pointer;transition:all 0.2s;background:#f7fafc;">
      <span style="font-weight:600;color:#4a5568;">B.</span> They are very sensitive and fragile
    </div>
    <div style="padding:1rem;border:2px solid #e2e8f0;border-radius:8px;cursor:pointer;transition:all 0.2s;background:#f7fafc;">
      <span style="font-weight:600;color:#4a5568;">C.</span> They use a ribbon suspended in a magnetic field
    </div>
    <div style="padding:1rem;border:2px solid #e2e8f0;border-radius:8px;cursor:pointer;transition:all 0.2s;background:#f7fafc;">
      <span style="font-weight:600;color:#4a5568;">D.</span> They are rugged and handle high sound pressure levels well
    </div>
  </div>
  
  <div style="margin-top:1.5rem;padding:1rem;background:#f0fff4;border-left:4px solid #48bb78;border-radius:8px;">
    <strong style="color:#2f855a;">💡 Correct Answer: D</strong>
    <p style="margin:0.5rem 0 0 0;color:#2f855a;">Dynamic microphones are rugged and can handle high sound pressure levels, making them ideal for live performances.</p>
  </div>
</div>
...
<div style="background:linear-gradient(135deg,#f093fb 0%,#f5576c 100%);color:white;padding:2rem;border-radius:16px;text-align:center;margin-top:3rem;">
  ...
  <p style="margin:0;font-size:1.1rem;opacity:0.9;">You've completed Module 3! You now understand microphone types and applications.</p>
</div>
`
  }
}; 
